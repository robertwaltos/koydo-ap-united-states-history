...
export const metadata: Metadata = {
  title: "Learn — AP United States History Practice",
  description: "Study and practice for AP United States History. Choose your subject and start preparing.",
};
    ...
    <main className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mb-2 text-3xl font-bold text-zinc-900 dark:text-zinc-100">
          AP United States History Study Hub
        </h1>
