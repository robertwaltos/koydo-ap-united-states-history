...
const EXAM_ID = "ap-united-states-history";
const EXAM_DISPLAY_NAME = "AP United States History (APUSH)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover all 9 periods of US history from 1491 to present. Teach LEQ, SAQ, DBQ, and CEX essay formats. Align to College Board AP US History CED.
